...
/**
 * @file stats.c 
 * @brief This file declares methods to perform statistical analysis on an
 * array of unsigned characters.
 *
 * This file declares methods to print array of unsigned characters, sort the
 * array, find the mean, median, maximum, and, minimum value in the array, and
 * method to print the statistics of the array.
 *
